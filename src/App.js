...
import Login from "./pages/athentification/Login";
import Register from "./pages/athentification/Register";
...
import MyPhotos from "./pages/steps/step3/idea-photos/MyPhotos";
import { useDispatch } from "react-redux";
import { auth } from "./firebase";
import { setUser } from "./redux/actions/actions";

const App = () => {
  //after refreshing user still connected till he log out
  ...
  //     if (authUser) {
  //       dispatch(setUser(authUser));
  //       const userId = authUser.uid; // Get the user ID
